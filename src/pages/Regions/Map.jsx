...
const Map = ({ selectedRegions, onRegionClick }) => (
  ...
  >
    ...
    <g
      id="almaty-city"
      role="checkbox"
      class="svg-map__group"
      onClick={() => onRegionClick("750000000")}
      aria-checked={selectedRegions.includes("750000000") ? "true" : "false"}
    >
      <g class="svg-map__city">
        <circle
          cx="496.092"
          cy="301.045"
          r="9"
          class="svg-map__city-path"
        ></circle>
        <text x="501.935" y="306.09" fontSize="14" class="svg-map__text">
          Алматы
        </text>
        <circle
          cx="496.092"
    ...
    >
      <g class="svg-map__city">
        <circle
          ...
          class="svg-map__city-path"
        ></circle>
        <text x="374.685" y="119.343" fontSize="14" class="svg-map__text">
          Астана
        </text>
        <circle
          cx="391.789"
    ...
    >
      <g class="svg-map__city">
        <circle
          ...
          class="svg-map__city-path"
        ></circle>
        <text x="348.962" y="348.16" fontSize="14" class="svg-map__text">
          Шымкент
        </text>
        <circle
          cx="370.928"
