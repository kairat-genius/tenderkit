      ...
      <div class="content__layout content__layout--md columns ng-star-inserted">
        <div class="columns__content">
          <article class="article">
            <img width="825" height="464" class="article__cover" src={data.img} alt={data.title} title={`${data.title} - image`} />
            <div class="article__content">
              <header class="article__header">
              {data.tags &&
                        data.tags.length > 0 &&
                        data.tags.slice(0, 3).map((tag, index) => (
                          <div class="article__tag tag tag--md ng-star-inserted" key={index}>
            ...
            <div class="article__footer">
              <div class="article__panel panel">
                <div class="panel__layout">
                  <span>
                    <strong class="txt txt--primary">{data.views}</strong> просмотра
                  </span>
                </div>
                <div class="panel__layout panel__layout--rtl">
              ...
              {author.author_articles.map((article, index) => (
                <li class="list__layout ng-star-inserted" key={index}>
                  <article class="article article--other not_article">
                    ...
                    <time class="article__date"> {formatDateMonth(article.created_at)} </time>
                  </article>
                </li>
              ))}
              </ul>
