  ...
  return (
          <div class="sr-item__actions ng-star-inserted">
            <div class="sr-item__action ng-star-inserted">
              <button class={`button button--secondary-transparent button--action button--sm ${isTracking ?'button--warning-transparent' : ''}`} onClick={handleTrackingToggle}>
            ...
            <div class="sr-item__action ng-star-inserted">
              <button class={`button button--secondary-transparent button--action button--sm ${isFavorite ? 'button--warning-transparent' : ''}`} onClick={handleFavoriteToggle}>
            ...
            <div clickoutside="" class="sr-item__action dropdown dropdown--folders sr-item__hint ng-star-inserted">
